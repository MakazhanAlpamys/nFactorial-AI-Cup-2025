...
exports.EvaluatorOptimizer = void 0;
class EvaluatorOptimizer {
     ...
     */
    async optimizeSearch(searchFn, query, imageFile) {
        let currentResponse;
        let iterations = 0;
        let memory = [];
        // Initial search
     ...
     */
    async evaluateResults(response, query, imageFile) {
        try {
     ...
     */
    combineSearchResults(responses) {
...
exports.EvaluatorOptimizer = EvaluatorOptimizer;
